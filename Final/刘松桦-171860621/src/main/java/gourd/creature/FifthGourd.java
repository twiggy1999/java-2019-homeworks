...
public class FifthGourd extends Creature{
    ...
    public FifthGourd(int mapX, int mapY, boolean isEnemy, int order){
        ...
        model=new Image("file:./src/main/resource/gourd5.png");
        imageView.setImage(model);

        head=new Image("file:./src/main/resource/head5.png");
        headView.setImage(head);

        miniView.setImage(head);

        HorizontalMagic myMagic1=new HorizontalMagic(new Image("file:./src/main/resource/water.png"),
                "水啊",this,5,50,3,1);
