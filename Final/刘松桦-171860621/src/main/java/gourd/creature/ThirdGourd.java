...
public class ThirdGourd extends Creature{
    ...
    public ThirdGourd(int mapX, int mapY, boolean isEnemy, int order){
        ...
        model=new Image("file:./src/main/resource/gourd3.png");
        imageView.setImage(model);

        head=new Image("file:./src/main/resource/head3.png");
        headView.setImage(head);

        miniView.setImage(head);

        HorizontalMagic myMagic1=new HorizontalMagic(new Image("file:./src/main/resource/cloud.png"),
                "回魂仙梦",this,-20,30,1,0);
