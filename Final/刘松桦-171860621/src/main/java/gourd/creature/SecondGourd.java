...
public class SecondGourd extends Creature{
    ...
    public SecondGourd(int mapX, int mapY, boolean isEnemy, int order){
        ...
        model=new Image("file:./src/main/resource/gourd2.png");
        imageView.setImage(model);

        head=new Image("file:./src/main/resource/head2.png");
        headView.setImage(head);

        miniView.setImage(head);

        HorizontalMagic myMagic1=new HorizontalMagic(new Image("file:./src/main/resource/grandpa.png"),
                "天外飞仙",this,15,40,2,0);
