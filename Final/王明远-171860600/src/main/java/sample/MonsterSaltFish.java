...
public class MonsterSaltFish extends Creature{
    ...
    public void provoke() // provoke in monstersaltfish version
    {
        System.out.println("My delicious food! Please fool me in my stomach!");
    }

 
    public void follow_orders(Identity id, int x, int y)// follow orther's order to goto someplace
    {
        if (id == Identity.MonsterScorpion)// follow monsterscorpion's order
        {
            ...
            ;// no response to saltfish or snake's order
