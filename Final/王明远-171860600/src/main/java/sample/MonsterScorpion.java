...
public class MonsterScorpion extends Creature{
   ...
   static public final int the_num_of_monstersaltfish=6;// the num of monstersaltfish
                                            //here we set this as 6
    ...
    public MonsterSaltFish []monsterSaltFishs=new MonsterSaltFish[the_num_of_monstersaltfish];// to store 15 saltfish
    ...
    public void summon_monstersaltfish()//give birth to monstersaltfish
    {
    ...
    public boolean decide_self_coordinate(SpaceForBattle space, int initial_x, int initial_y)// decide one's coordinate
    {
    ...
    public void study_military_for_monster()// initialize military book by known the size the num and the direction
    {
        military_for_monster=new StandLaw(the_num_of_monstersaltfish+1,direction_of_attack,size_of_space_for_battle);
    }

    public void provoke()// provoke in monsterscorpion version
    {
    ...
    public void follow_orders(Identity id, int x, int y)// refuse to follow orders by anyone else
    {
        provoke();
    }
