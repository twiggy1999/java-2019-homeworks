public class homework4
{
    public static void main(String[] args)
    {
        ...
        w.Sort();
        w.Printmap();
        System.out.println("鹤翼阵，并放入爷爷和蛇精");
        Formation <CraneWing>tp1=new Formation <CraneWing>(new CraneWing());
        CraneWing crane=tp1.getFormation();
        w.StandBadguys(crane);  
        System.out.print("考察反射机制，当前类型为:");
        w.ShowTheFormationType(crane);    
        ...
        w.StandRandomly();
        w.Sort();
        System.out.println("雁行阵，并放入爷爷和蛇精");
        Formation <WildGooseFly>tp2=new Formation <WildGooseFly>(new WildGooseFly());
        WildGooseFly wild=tp2.getFormation();
        w.StandBadguys(wild);  
        System.out.print("考察反射机制，当前类型为:");
        w.ShowTheFormationType(wild);        
...
class Formation<T>
{
   ...
   // int row;
    ...
    {
        formation.arrange(head,t,map,row,column);
    }*/
}
...
class World
{
    ...
    <T>void ShowTheFormationType(T formation)
    {
        System.out.println(formation.getClass().getName());
    }
    void StandBadguys(CraneWing formation)
    {
        formation.row=N/2+1;
        formation.column=3*N/4;
        //System.out.println(formation.getClass().getName());
        //formation.setPosition(N/2+1,3*N/4);
        formation.arrange(Scorpion,Nobodys,map);
    }
    void StandBadguys(WildGooseFly formation)
    {
        formation.row=N/2+1;
        formation.column=3*N/4;
        //System.out.println(formation.getClass().getName());
    ...
    /*<T> void setPosition(T formation)
    {
        formation.row=N/2+1;
        formation.column=3*N/4;
    }*/
