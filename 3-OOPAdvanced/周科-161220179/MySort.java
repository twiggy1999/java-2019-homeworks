...
public class MySort {
    ...
    static int array[]={7,2,1,4,3,6,5};
    public CalabashBrothers[] QueueBoys;

    MySort(){
       QueueBoys=new CalabashBrothers[7];
    }
...
*/
    ...
    public void BubbleSortBoys(){
        int len=7;
        //CalabashBrothers[] QueueBoys=new CalabashBrothers[len];
        for(int i=0;i<len;i++){
            QueueBoys[i]=new CalabashBrothers(array[i]-1);
        }
